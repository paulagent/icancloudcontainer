...
void CloudSchedulerRandom::initialize(){
...
vector<AbstractNode*> CloudSchedulerRandom::selectStorageNodes (AbstractRequest* st_req){
    ...
    // Initialize ..
        ...
        if (streq == NULL) throw cRuntimeError("CloudSchedulerRandom::selectStorageNodes ->can not cast to storage request\n");
...
int CloudSchedulerRandom::selectNodeSet (string setName, int vmcpu, int vmmemory){
