...
#ifndef DOCKERENGINE_H_
#define DOCKERENGINE_H_

#include "icancloud_Base.h"

class DockerEngine : public icancloud_Base
{
   private:
        ...
        cGateManager* fromVmMsgController;                       // Input gate from this class to the operative system
        cGateManager* toVmMsgController;                         // Output gate from this class to theVirtual Machine Msg Controller
        cGateManager* fromContainers;                         // Input gate from this class to an application
    ...
    public:
        ...
        /*
         * This method links a new Container.
         */
        void linkNewContainer(cModule* jobAppModule, cGate* scToApp, cGate* scFromApp);

        /*
         * This method unlink the given application as parameter. It disconnects all the gates (4)
         */
        int unlinkContainer(cModule* jobAppModule);
