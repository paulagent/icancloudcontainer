//
// Generated file, do not edit! Created by nedtool 4.6 from src/Base/Messages/icancloud_Container_NET_Message.msg.
//
...
icancloud_Container_NET_Message_Base::icancloud_Container_NET_Message_Base(const char *name, int kind) : ::icancloud_Message(name,kind)
{
...
icancloud_Container_NET_Message_Base::icancloud_Container_NET_Message_Base(const icancloud_Container_NET_Message_Base& other) : ::icancloud_Message(other)
{
    copy(other);
}

icancloud_Container_NET_Message_Base::~icancloud_Container_NET_Message_Base()
{
}

icancloud_Container_NET_Message_Base& icancloud_Container_NET_Message_Base::operator=(const icancloud_Container_NET_Message_Base& other)
{
...
void icancloud_Container_NET_Message_Base::copy(const icancloud_Container_NET_Message_Base& other)
{
...
void icancloud_Container_NET_Message_Base::parsimPack(cCommBuffer *b)
{
...
void icancloud_Container_NET_Message_Base::parsimUnpack(cCommBuffer *b)
{
...
const char * icancloud_Container_NET_Message_Base::getDestinationIP() const
{
    return destinationIP_var.c_str();
}

void icancloud_Container_NET_Message_Base::setDestinationIP(const char * destinationIP)
{
    this->destinationIP_var = destinationIP;
}

const char * icancloud_Container_NET_Message_Base::getLocalIP() const
{
    return localIP_var.c_str();
}

void icancloud_Container_NET_Message_Base::setLocalIP(const char * localIP)
{
    this->localIP_var = localIP;
}

int icancloud_Container_NET_Message_Base::getDestinationPort() const
{
    return destinationPort_var;
}

void icancloud_Container_NET_Message_Base::setDestinationPort(int destinationPort)
{
    this->destinationPort_var = destinationPort;
}

int icancloud_Container_NET_Message_Base::getLocalPort() const
{
    return localPort_var;
}

void icancloud_Container_NET_Message_Base::setLocalPort(int localPort)
{
    this->localPort_var = localPort;
}

const char * icancloud_Container_NET_Message_Base::getConnectionType() const
{
    return connectionType_var.c_str();
}

void icancloud_Container_NET_Message_Base::setConnectionType(const char * connectionType)
{
    this->connectionType_var = connectionType;
}

unsigned int icancloud_Container_NET_Message_Base::getSize() const
{
    return size_var;
}

void icancloud_Container_NET_Message_Base::setSize(unsigned int size)
{
    this->size_var = size;
}

const char * icancloud_Container_NET_Message_Base::getData() const
{
    return data_var.c_str();
}

void icancloud_Container_NET_Message_Base::setData(const char * data)
{
    this->data_var = data;
}

const char * icancloud_Container_NET_Message_Base::getVirtual_destinationIP() const
{
    return virtual_destinationIP_var.c_str();
}

void icancloud_Container_NET_Message_Base::setVirtual_destinationIP(const char * virtual_destinationIP)
{
    this->virtual_destinationIP_var = virtual_destinationIP;
}

const char * icancloud_Container_NET_Message_Base::getVirtual_localIP() const
{
    return virtual_localIP_var.c_str();
}

void icancloud_Container_NET_Message_Base::setVirtual_localIP(const char * virtual_localIP)
{
    this->virtual_localIP_var = virtual_localIP;
}

int icancloud_Container_NET_Message_Base::getVirtual_user() const
{
    return virtual_user_var;
}

void icancloud_Container_NET_Message_Base::setVirtual_user(int virtual_user)
{
    this->virtual_user_var = virtual_user;
}

int icancloud_Container_NET_Message_Base::getVirtual_destinationPort() const
{
    return virtual_destinationPort_var;
}

void icancloud_Container_NET_Message_Base::setVirtual_destinationPort(int virtual_destinationPort)
{
    this->virtual_destinationPort_var = virtual_destinationPort;
}

int icancloud_Container_NET_Message_Base::getVirtual_localPort() const
{
    return virtual_localPort_var;
}

void icancloud_Container_NET_Message_Base::setVirtual_localPort(int virtual_localPort)
{
    this->virtual_localPort_var = virtual_localPort;
}

const char * icancloud_Container_NET_Message_Base::getFsType() const
{
    return fsType_var.c_str();
}

void icancloud_Container_NET_Message_Base::setFsType(const char * fsType)
{
    this->fsType_var = fsType;
}

int icancloud_Container_NET_Message_Base::getTargetPosition() const
{
    return targetPosition_var;
}

void icancloud_Container_NET_Message_Base::setTargetPosition(int targetPosition)
{
    this->targetPosition_var = targetPosition;
}

class icancloud_Container_NET_MessageDescriptor : public cClassDescriptor
{
  public:
    icancloud_Container_NET_MessageDescriptor();
    virtual ~icancloud_Container_NET_MessageDescriptor();
...
Register_ClassDescriptor(icancloud_Container_NET_MessageDescriptor);

icancloud_Container_NET_MessageDescriptor::icancloud_Container_NET_MessageDescriptor() : cClassDescriptor("icancloud_Container_NET_Message", "icancloud_Message")
{
}

icancloud_Container_NET_MessageDescriptor::~icancloud_Container_NET_MessageDescriptor()
{
}

bool icancloud_Container_NET_MessageDescriptor::doesSupport(cObject *obj) const
{
    return dynamic_cast<icancloud_Container_NET_Message_Base *>(obj)!=NULL;
}

const char *icancloud_Container_NET_MessageDescriptor::getProperty(const char *propertyname) const
{
...
int icancloud_Container_NET_MessageDescriptor::getFieldCount(void *object) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    return basedesc ? 14+basedesc->getFieldCount(object) : 14;
}

unsigned int icancloud_Container_NET_MessageDescriptor::getFieldTypeFlags(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
...
const char *icancloud_Container_NET_MessageDescriptor::getFieldName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int icancloud_Container_NET_MessageDescriptor::findField(void *object, const char *fieldName) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
...
const char *icancloud_Container_NET_MessageDescriptor::getFieldTypeString(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *icancloud_Container_NET_MessageDescriptor::getFieldProperty(void *object, int field, const char *propertyname) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
int icancloud_Container_NET_MessageDescriptor::getArraySize(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
    ...
    icancloud_Container_NET_Message_Base *pp = (icancloud_Container_NET_Message_Base *)object; (void)pp;
    switch (field) {
        default: return 0;
    }
}

std::string icancloud_Container_NET_MessageDescriptor::getFieldAsString(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
bool icancloud_Container_NET_MessageDescriptor::setFieldAsString(void *object, int field, int i, const char *value) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
const char *icancloud_Container_NET_MessageDescriptor::getFieldStructName(void *object, int field) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
...
void *icancloud_Container_NET_MessageDescriptor::getFieldStructPointer(void *object, int field, int i) const
{
    cClassDescriptor *basedesc = getBaseClassDescriptor();
    if (basedesc) {
        if (field < basedesc->getFieldCount(object))
